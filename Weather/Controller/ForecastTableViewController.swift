...
//        let forcastDtText = forecastItem[indexPath.row].dtText
        ...
        cell.tempMinLabel.text = "↙️ \(Int(forecastMain.tempMin))ºC" //String(format: "↙️ %.0fºC", forecastMain.tempMin)
        cell.tempMaxLabel.text = "↗️ \(Int(forecastMain.tempMax))ºC" //String(format: "↗️ %.0fºC", forecastMain.tempMax)
